...
int main(int argc, char** argv)
{
	...
	if(mass_ratio==0.6){
		rootFilename.Form("./cross_section_%.2f_ratio_%.2f_scalar_fix.root",mV,mass_ratio);
	}

	else{
		rootFilename.Form("./cross_section_%.3f_ratio_%.2f_scalar_fix.root",mV,mass_ratio);
	}
